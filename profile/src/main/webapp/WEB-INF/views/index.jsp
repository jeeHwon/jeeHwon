				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<div class="profile-thumb" style="background: url(resources/images/user-3.jpg);"></div>
							<h1><span>Seungwon Ji</span></h1>
							<h3><span>ML engineer / Product Manager</span></h3>
							<p>
				...
				<div class="col-md-12 col-md-offset-0">
					<ul class="timeline">
						...
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">ML 프로젝트(진행중)</h3>
									<span class="company">개인 프로젝트- 2021.03 - Current</span>
								</div>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">팀프로젝트- 2021.02 - 2021.03</span>
								</div>
								<div class="timeline-body">
									<p>식재료 가격 및 트렌드 동향에 따른 맞춤형 식단 추천 서비스 기획  / MLP Regressor 이용한 식재료 가격 예측 시스템 구축 / 식단 추천 알고리즘 개발</p>
								</div>
							</div>
						</li>
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">스터디 - 2021.01 - Current</span>
								</div>
								<div class="timeline-body">
									<p>단단한 머신러닝 챕터 발표 / Kaggle 참여</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">개인 프로젝트 - 2020.12 - 2021.02</span>
								</div>
								<div class="timeline-body">
									<p>매일 자동으로 실행 + 주식매매 + DB최신화 + 종목추천 프로그램 개발 / Keras Sequential model 활용한 주식 가격 예측하여 종목 추천 / 현재까지 프로그램 사용중, 수익률은 비공개.</p>
								</div>
							</div>
						</li>
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">팀프로젝트 - 2020.11 - 2021.01</span>
								</div>
								<div class="timeline-body">
									<p>인증 시스템을 갖춘 보증금 중심의 소셜 웹 서비스 기획 / 인증방법 선택 및 방 생성 기능 구현 / 메인페이지 디자인 / 인증방 만들기, 리스트, 방세부보기, 결제 페이지 구현</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">개인공부 - 2020.10 - Current</span>
								</div>
								<div class="timeline-body">
									<p>Java / JSP / Spring / Algorithm(Java, Python, C++) / dJango / R</p>
								</div>
							</div>
						</li>
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">개인프로젝트 - 2020.10 - 2020.10</span>
								</div>
								<div class="timeline-body">
									<p>Google Teachable Machine 활용해 코를 파는 행위를 감지해 경고해주는 프로그램 / 나의 첫 프로젝트</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">코딩입문 - 2020.08 ~  </span>
								</div>
								<div class="timeline-body">
									<p>인생 제 2막을 열게된 첫 시작, 첫 코드. "Hello World!~"</p>
								</div>
							</div>
						</li>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">머신러닝 기반 SW 개발자 양성과정</h3>
									<span class="company">경영기술개발원 - 2020.08 - 2021.03</span>
								</div>
								<div class="timeline-body">
									<p>머신러닝 플랫폼을 활용한 응용소프트웨어 개발과정 수료 / JAVA 기초 / Oracle DB / Servlet&JSP / Spring Framework / Hadoop / R / Python / ML 학습하여 자바 기반의 빅데이터 분석 응용 SW 개발 능력 구비 </p>
								</div>
							</div>
						</li>
						<li class="animate-box timeline-unverted">
